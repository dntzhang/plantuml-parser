...
exports.File = exports.UML = exports.Relationship = exports.Group = exports.Actor = exports.Class = exports.Interface = exports.Enum = exports.MemberVariable = exports.Method = exports.UseCase = exports.Component = exports.Note = exports.Comment = void 0;
...
var Actor = /** @class */ (function () {
    function Actor(name, title, isAbstract, members, extends_, implements_) {
        if (members === void 0) { members = []; }
        if (extends_ === void 0) { extends_ = []; }
        if (implements_ === void 0) { implements_ = []; }
        this.name = name;
